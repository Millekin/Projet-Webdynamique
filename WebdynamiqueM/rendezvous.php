...
WHERE creneau.`id_professionel` = utilisateur.`id_utilisateur` AND 
creneau.id_etudiant='".$_SESSION['id_eleve']."'";
...
<body>
    <div id="wrapper">
        ...
        <div id="nav">
            ...
            <a href="rendezvous.php"><img src="img/RVL.jpg" alt="Rendez-vous" width="150" height="50"></a>
            ...
            <?php
                            ...
                            // output data of each row
                                while($row = $resultElec->fetch_assoc()) {
                                    ?>
                                    <li><?php echo "<br>Dates de debut et de fin: Du ".$row["debut"]." au ".$row["fin"]."<br>Indications: ".$row["texte"]."<br>Professionnel: ".$row["nom"]." ".$row["prenom"]."<br>";?></li>
                                    <a href="supprCreneau.php?id=<?php echo $row['id_creneau']; ?>" class="button">Annuler le rendez-vous</a>
                                    <?php
                                }
                            }
                            ?>
